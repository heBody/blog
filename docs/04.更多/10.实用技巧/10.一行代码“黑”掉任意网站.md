...
<p align="center"><img src="/blog/img/p1.png" width="500" style="cursor: zoom-in;"></p>
...
<p align="center"><img :src="$withBase('/img/p2.png')" width="600" style="cursor: zoom-in;"></p>

以后在任意网站，只需要轻轻一点`切换模式`书签就可以让它变成85%的暗黑，再点一次就是100%的暗黑，再点一次变回正常模式。

<p align="center"><img :src="$withBase('/img/p1.png')" width="600" style="cursor: zoom-in;"></p>
