/**
 * 提示：如您想使用JS版本的配置文件可参考：https://github.com/heBody/blog/tree/a2f03e993dd2f2a3afdc57cf72adfc6f1b6b0c32/docs/.vuepress
 */
import { resolve } from 'path'
import { defineConfig4CustomTheme, UserPlugins } from 'vuepress/config'
import { VdoingThemeConfig } from 'blog/types'
import dayjs from 'dayjs'
import baiduCode from './config/baiduCode' // 百度统计hm码
import htmlModules from './config/htmlModules' // 自定义插入的html块

const DOMAIN_NAME = 'fseller.com' // 域名 (不带https)
...
export default defineConfig4CustomTheme<VdoingThemeConfig>({
  ...
  themeConfig: {
    ...
    nav: [
      { text: '首页', link: '/' },
      { text: '个人游戏网站', link: 'http://fseller.com'},
      {
        text: '前端',
    ...
    repo: 'heBody/blog', // 导航栏右侧生成Github链接
    ...
    //*** 以下是Vdoing主题相关配置，文档：https://doc.heBody.com/pages/a20ce8/ ***//
    ...
    author: {
      name: 'heBody', // 必需
      link: 'https://github.com/heBody', // 可选的
    },
    ...
    // 社交图标 (显示于博主信息栏和页脚栏。内置图标：https://doc.heBody.com/pages/a20ce8/#social)
    social: {
