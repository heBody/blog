  ...
  <div class="wrap" :class="'mode-' + mode" @touchstart="handleTouchstart">
    ...
    <div v-if="isReadImages">
      ...
      <img
        ...
        class="hide-img"
        id="qrcode"
        src="https://cdn.jsdelivr.net/gh/heBody/image_store2@master/img/qrcode.zul0pldsuao.png"
      />
    </div>

    <!-- 背景音乐 -->
    <audio
      src="https://cdn.jsdelivr.net/gh/heBody/image_store2@master/cjxq.mp3"
      id="bgm"
      ref="bgm"
      loop
    />
...
export default {
  ...
  data() {
    return {
      ...
      bgList: [
        'https://cdn.jsdelivr.net/gh/heBody/image_store@master/1.4j8qpdnq80i0.jpeg',
        'https://cdn.jsdelivr.net/gh/heBody/image_store@master/4.4460an8ag5o0.jpeg',
        'https://cdn.jsdelivr.net/gh/heBody/image_store@master/5.3axtl4xpvy00.jpeg',
        'https://cdn.jsdelivr.net/gh/heBody/image_store@master/6.2lnbphdqjaq0.jpeg',
      ],
...
> [手写春联](https://cl.heBody.com/)</br>
> [FC在线模拟器](https://game.heBody.com/)</br>
> [爱国头像生成器](https://avatar.heBody.com/)</br>
> [到账语音生成器](https://zfb.heBody.com/)
